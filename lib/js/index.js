...
var DateRange = function (_React$Component) {
  ...
  function DateRange(props) {
    ...
    _this.state = {
      ...
      minDate: _commonFn2.default.ymd(props.minDate || '2016-01-02'),
      maxDate: _commonFn2.default.ymd(props.maxDate || '2100-01-01'),
      startMonth: _commonFn2.default.ym(props.startDate), // 默认开始月份
      endMonth: props.endDate ? _commonFn2.default.ym(props.endDate) : (0, _moment2.default)(props.startDate || undefined).add(1, 'months').format('YYYY-MM'), // 默认结束月份
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', className: 'start-time', value: startDate }),
          _react2.default.createElement(
            'span',
            { className: 'clip-span' },
            '\u2014\u2014'
          ),
          _react2.default.createElement('input', { type: 'text', className: 'end-time', value: endDate })
        ),
        _react2.default.createElement(
          'div',
          {
