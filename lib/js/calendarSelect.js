    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          (sync !== 'end' && viewMode !== 'month' || viewMode === 'year') && _react2.default.createElement('span', { className: 'prev-year fa fa-backward', onClick: function onClick() {
              return _this2.yearMonthChange(-1, 'year');
            } }),
          sync !== 'end' && viewMode === 'day' && _react2.default.createElement('span', { className: 'prev-month fa fa-caret-left', onClick: function onClick() {
              return _this2.yearMonthChange(-1, 'month');
            } }),
          sync !== 'start' && viewMode === 'day' && _react2.default.createElement('span', { className: 'next-month fa fa-caret-right', onClick: function onClick() {
              return _this2.yearMonthChange(1, 'month');
            } }),
          (sync !== 'start' && viewMode !== 'month' || viewMode === 'year') && _react2.default.createElement('span', { className: 'next-year fa fa-forward', onClick: function onClick() {
              return _this2.yearMonthChange(1, 'year');
            } }),
          _react2.default.createElement(
            'span',
